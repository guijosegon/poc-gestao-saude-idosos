            ...
            modelBuilder.Entity("GestaoSaudeIdosos.Domain.Entities.FormularioResultado", b =>
                {
                    ...
                    b.Property<int?>("UsuarioAplicacaoId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GestaoSaudeIdosos.Domain.Entities.FormularioResultadoValor", b =>
                {
                    ...
                    b.HasIndex("FormularioResultadoId");
            ...
            modelBuilder.Entity("GestaoSaudeIdosos.Domain.Entities.Grafico", b =>
                {
                    ...
                    b.Property<bool>("ExibirNoPortal")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("GestaoSaudeIdosos.Domain.Entities.FormularioResultado", b =>
                {
                    ...
                    b.HasOne("GestaoSaudeIdosos.Domain.Entities.Usuario", "UsuarioAplicacao")
                        .WithMany()
            ...
            modelBuilder.Entity("GestaoSaudeIdosos.Domain.Entities.FormularioResultadoValor", b =>
                {
                    ...
                    b.HasOne("GestaoSaudeIdosos.Domain.Entities.FormularioResultado", "FormularioResultado")
                        .WithMany("Valores")
                        .HasForeignKey("FormularioResultadoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("FormularioResultado");
                });
